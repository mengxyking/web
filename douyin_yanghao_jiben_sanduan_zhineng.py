...
class PklViewer(QMainWindow):
    ...
    def __init__(self):
        ...
        file_temp_path_comment = get_value_by_key_pkl("shuju_config.pkl", "file_path_comment666")
        ...
        # 新增“选择手机”配置相关组件
        # self.select_phone_label = QLabel("选择手机:")
        # self.select_phone_input = QLineEdit()
        # self.select_phone_input.setPlaceholderText("输入序号，如1、1,2、1-5")
        ...
        # 把这些组件加入布局，比如加到horizontal_layout上方
        # layout.insertWidget(layout.indexOf(self.caozuo_config), self.select_phone_label)
        # layout.insertWidget(layout.indexOf(self.caozuo_config), self.select_phone_input)
        # layout.insertWidget(layout.indexOf(self.caozuo_config), self.confirm_select_button)
    ...
    def showDialog_comment(self):
        ...
        if dialog.exec() == QFileDialog.DialogCode.Accepted:
            ...
            if selected_files:
                ...
                updata_pkl_config_mianban("file_path_comment666", selected_file)
                #self.excel_file = selected_file
                #self.import_config()
                #self.refresh_pkl_files_test()
