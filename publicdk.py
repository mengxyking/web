...
def operate_device(serial, dir_path, task,big,small,jiarenshuliang):
    ...
    if(str(task).count("douyin")>0):
        print("当前是抖音任务")
        updata_pkl("./shuju/" + str(serial) + ".pkl", "进行的任务", "dy任务中")
...
class PklViewer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.radio_button2 = QCheckBox("ks养号")
        self.radio_button3 = QCheckBox("视频号")
        self.radio_button3.setChecked(True)
        self.radio_button4 = QCheckBox("vx")
    ...
    def execute_button_clicked(self):
        ...
        if (self.radio_button2.isChecked() == True):
            tasks.append("kuaishou")
        if (self.radio_button3.isChecked() == True):
            tasks.append("shipinhao")
