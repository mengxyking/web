...
import time
import uuid
import jingdong_daoxu_aozhou_feiting
...
def run_script():
    ...
    try:
        ...
        if(checkbox222.isChecked() == True):
           dic111 = {"mingci":combo_box222.currentText(),"leixing":combo_box2222.currentText(),"zhengfan":zhengfan_box111.currentText()}
           shuzu.append(dic111)
        if (checkbox333.isChecked() == True):
            dic222 = {"mingci": combo_box333.currentText(), "leixing": combo_box3333.currentText(),"zhengfan":zhengfan_box222.currentText()}
            shuzu.append(dic222)
        if (checkbox444.isChecked() == True):
            dic333 = {"mingci": combo_box444.currentText(), "leixing": combo_box4444.currentText(),"zhengfan":zhengfan_box333.currentText()}
            shuzu.append(dic333)
        if (checkbox555.isChecked() == True):
            dic333 = {"mingci": combo_box555.currentText(), "leixing": combo_box5555.currentText(),"zhengfan":zhengfan_box444.currentText()}
            shuzu.append(dic333)
        if (checkbox555_add_1.isChecked() == True):
            dic333 = {"mingci": combo_box555_add_1.currentText(), "leixing": combo_box5555_add_1.currentText(),"zhengfan":zhengfan_box555.currentText()}
            shuzu.append(dic333)
        if (checkbox666.isChecked() == True):
            dic333 = {"mingci": combo_box666.currentText(), "leixing": combo_box6666.currentText(),"zhengfan":zhengfan_box666.currentText()}
            shuzu.append(dic333)
        if (checkbox777.isChecked() == True):
            dic333 = {"mingci": combo_box777.currentText(), "leixing": combo_box7777.currentText(),"zhengfan":zhengfan_box777.currentText()}
            shuzu.append(dic333)
        if (checkbox888.isChecked() == True):
            dic333 = {"mingci": combo_box888.currentText(), "leixing": combo_box8888.currentText(),"zhengfan":zhengfan_box888.currentText()}
            shuzu.append(dic333)
        if (checkbox999.isChecked() == True):
            dic333 = {"mingci": combo_box999.currentText(), "leixing": combo_box9999.currentText(),"zhengfan":zhengfan_box999.currentText()}
            shuzu.append(dic333)
        if (checkbox101010.isChecked() == True):
            dic333 = {"mingci": combo_box101010.currentText(), "leixing": combo_box10101010.currentText(),"zhengfan":zhengfan_box101010.currentText()}
            shuzu.append(dic333)
        if (checkbox111111.isChecked() == True):
            dic333 = {"mingci": combo_box111111.currentText(), "leixing": combo_box11111111.currentText(),"zhengfan":zhengfan_box111111.currentText()}
            shuzu.append(dic333)
        if (checkbox121212.isChecked() == True):
            dic333 = {"mingci": combo_box121212.currentText(), "leixing": combo_box12121212.currentText(),"zhengfan":zhengfan_box121212.currentText()}
            shuzu.append(dic333)
        if (checkbox131313.isChecked() == True):
            dic333 = {"mingci": combo_box131313.currentText(), "leixing": combo_box13131313.currentText(),"zhengfan":zhengfan_box131313.currentText()}
            shuzu.append(dic333)
        if (checkbox141414.isChecked() == True):
            dic333 = {"mingci": combo_box141414.currentText(), "leixing": combo_box14141414.currentText(),"zhengfan":zhengfan_box141414.currentText()}
            shuzu.append(dic333)
        if (checkbox151515.isChecked() == True):
            dic333 = {"mingci": combo_box151515.currentText(), "leixing": combo_box15151515.currentText(),"zhengfan":zhengfan_box151515.currentText()}
            shuzu.append(dic333)
        if (checkbox161616.isChecked() == True):
            dic333 = {"mingci": combo_box161616.currentText(), "leixing": combo_box16161616.currentText(),"zhengfan":zhengfan_box161616.currentText()}
            shuzu.append(dic333)

        if (checkbox171717.isChecked() == True):
            dic333 = {"mingci": combo_box171717.currentText(), "leixing": combo_box17171717.currentText(),"zhengfan":zhengfan_box171717.currentText()}
            shuzu.append(dic333)
        if (checkbox181818.isChecked() == True):
            dic333 = {"mingci": combo_box181818.currentText(), "leixing": combo_box18181818.currentText(),"zhengfan":zhengfan_box181818.currentText()}
            shuzu.append(dic333)
        if (checkbox191919.isChecked() == True):
            dic333 = {"mingci": combo_box191919.currentText(), "leixing": combo_box19191919.currentText(),"zhengfan":zhengfan_box191919.currentText()}
            shuzu.append(dic333)
        if (checkbox202020.isChecked() == True):
            dic333 = {"mingci": combo_box202020.currentText(), "leixing": combo_box20202020.currentText(),"zhengfan":zhengfan_box202020.currentText()}
            shuzu.append(dic333)
        for temp in shuzu:
            print(temp)
        print("开始执行脚本")
        jingdong_daoxu_aozhou_feiting.main_gui(file_textbox.text(),start_textbox_kami.text(),shuzu,file_textbox_tz_dizhi.text(),file_textbox_jiekou_dizhi.text(),file_textbox_jiekou_dizhi_feiting.text(),touzhu_zhengfan.currentText())
...
app = QApplication([])
window = QWidget()
window.setWindowTitle("模拟测试澳洲飞艇")
...
zhengfan_box111.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box222.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box333.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box444.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box555.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box666.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box777.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box888.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box999.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box101010.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box111111.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box121212.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box131313.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box141414.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box151515.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box161616.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box171717.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box181818.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box191919.addItems(["跟飞艇","反飞艇"])
...
zhengfan_box202020.addItems(["跟飞艇","反飞艇"])
