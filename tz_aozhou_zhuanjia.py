...
def run_script():
    ...
    try:
        ...
        jingdong_aozhou_zhuanjia.main_gui(file_textbox.text(),start_textbox_kami.text(),checkboxess,file_textbox_tz_dizhi.text(),file_textbox_jiekou_dizhi.text(),combo_box222_zhuanjia.currentText(),combo_box222_zhuanjia_gen_fan.currentText(),combo_box222_zhuanjia_jianyishou.currentText())
