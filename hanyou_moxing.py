...
def operate_device(serial, dir_path, task,big,small,jiarenshuliang):
    ...
    if(5.0 in result.keys()):
        ...
        d.click(result[3.0][0]-165, result[3.0][1])
        d.click(result[3.0][0]-165, result[3.0][1])
        d.click(result[3.0][0]-165, result[3.0][1])
    ...
    while(count<28):
        ...
        target_x = target_x + count%4*90
        target_y = target_y + count//4*100
