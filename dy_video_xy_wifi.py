...
def operate_device(serial, dir_path, task,big,small,jiarenshuliang):
    ...
    if(device_name != None):
        device_name = str(str(device_name).split(":")[0]).strip()
    ...
    # time.sleep(3)
    try:
        bbb(d, serial, jiarenshuliang,big,device_name)
...
class PklViewer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.label_from = QLabel('                          每隔多少次杀一次app：')
        ...
        self.label_seconds = QLabel('次', self)
