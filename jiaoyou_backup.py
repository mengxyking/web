...
def main(serial):
    ...
    swipe_count        = int(get_value_by_key_pkl(shuju_config_file_name, "huadongcishuxiao") or "8")
    ...
    while(True):
        ...
        if(str(d.app_current()).count("com.yanzhiyu.dahai") > 0): #com.yanzhiyu.dahai:id/et_content_container
            print("当前是附近陌约")
            ids["txt_top_center"] = "com.yanzhiyu.dahai:id/txt_top_center"
            ...
            ids["tv_next"] = "com.yanzhiyu.dahai:id/tv_next"
        elif(str(d.app_current()).count("com.huanyou.fjxasn") > 0):
            print("当前是寻爱")
        elif (str(d.app_current()).count("com.pangdaishu.huanyou") > 0):
            print("当前是欢友")
        else:
            print("当前不在三个APP里面")
            continue
        ...
        for i in range(2):
            print(f"-------------{i+1}-----------------")
            if (d(resourceId="com.huanyou.fjxasn:id/tv_hint").exists(timeout=3)):  # com.huanyou.fjxasn:id/et_content_container
                print("当前有会话框111")
                random_click_view(d, d(resourceId="com.huanyou.fjxasn:id/tv_hint"))
                ...
                if (d(resourceId="com.huanyou.fjxasn:id/et_content_container").exists(timeout=3)):
                    print("当前输入了，找发送按钮")
                    el = d(resourceId="com.huanyou.fjxasn:id/et_content_container")
                    ...
                    continue
            time.sleep(8)
        if (d(resourceId="com.huanyou.fjxasn:id/tv_next").exists(timeout=3)):
            print("you 下一个，点击下一个")
            random_click_view(d,d(resourceId="com.huanyou.fjxasn:id/tv_next"))
        else:
...
class PklViewer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.label_from_time = QLabel('xxxxxxxx1')
