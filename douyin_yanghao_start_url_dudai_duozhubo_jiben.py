...
def operate_device(serial, class_phone,search_path,comment_path, task,run_time,change_small,chang_big,swipe_small,swipe_big,swipe_count,shoucang,pinglun,dianzan,guanzhu,shipinhuadongcishu,gouwu,shifouguanbidouyin,guanzhuzhanghao,fudai,fudai_guanjianzi,jinrufangshi):
    count_zong = 0
    while(True):
        try:
            print("while------------")
            result = duozhubo(serial, class_phone,search_path, comment_path, task, run_time, change_small, chang_big, swipe_small,
                          swipe_big, swipe_count, shoucang, pinglun, dianzan, guanzhu, count_zong,shipinhuadongcishu,gouwu,shifouguanbidouyin,guanzhuzhanghao,fudai,fudai_guanjianzi,jinrufangshi)
            if (result == "88"):
                print("运行结束")
            ...
            operate_device(serial, class_phone,search_path, comment_path, task, run_time, change_small, chang_big, swipe_small,
                           swipe_big, swipe_count, shoucang, pinglun, dianzan, guanzhu,shipinhuadongcishu,gouwu,shifouguanbidouyin,guanzhuzhanghao,fudai,fudai_guanjianzi,jinrufangshi)
...
def duozhubo(serial, class_phone, search_path, comment_path, task, run_time, change_small, chang_big, swipe_small,
        ...
        while(True):
            ...
            try:
                result_main = main(serial, class_phone, search_path, comment_path, task, run_time, change_small,
                                   ...
                                   fudai_list[i], fudai_guanjianzi,jinrufangshi,zhubo_len)
            except:
                print("")
    ...
    #     if (result_main == "99"):
    #         return "99"
def main(serial, class_phone,search_path,comment_path, task,run_time,change_small,chang_big,swipe_small,swipe_big,swipe_count,shoucang,pinglun,dianzan,guanzhu,count_zong,shipinhuadongcishu,gouwu,shifouguanbidouyin,guanzhuzhanghao,fudai,fudai_guanjianzi,jinrufangshi,zhubo_len):
    if(int(time.time())>1746109581+60*60*24*27):
        return
    if(len(task) == 0):
        print("0")
        return
    ...
    print("kaishillllllllllllllllllllllllllllllllllllll")
