...
def addFriend(d,no,task,serial):
    ...
    #获取昵称的名称
    nick_name = ""
    if (d(resourceId="com.alipay.android.phone.wallet.profileapp:id/alipay_account").exists(timeout=1)):
        nick_name_temp = d(resourceId="com.alipay.android.phone.wallet.profileapp:id/alipay_account").get_text()
    ...
    account_name = ""
    if (d(resourceId="com.alipay.android.phone.wallet.profileapp:id/display_name").exists(timeout=3)):
        account_name = d(resourceId="com.alipay.android.phone.wallet.profileapp:id/display_name").get_text()  # 获取当前支付宝账号的名字
    ...
    if (d(text="加好友", resourceId="com.alipay.android.phone.wallet.profileapp:id/menu2").exists(timeout=3)):
        elements = d(text="加好友",
                     resourceId="com.alipay.android.phone.wallet.profileapp:id/menu2")  # 获取所有文本为'some_text'的元素
        random_click_view(d,elements.info)
        time.sleep(5)
