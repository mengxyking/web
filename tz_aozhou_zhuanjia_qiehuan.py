...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QComboBox, QCheckBox, \
...
import jingdong_aozhou_zhuanjia
import jingdong_aozhou_zhuanjia_qiehuan
...
def run_script():
    ...
    try:
        ...
        print("开始执行脚本") #file_textbox 浏览器路径配置  start_textbox_kami：投注策略配置，boxs:投注赛道，file_textbox_tz_dizhi：网址，file_textbox_jiekou_dizhi：获取结果的接口地址,选择的专家
        jingdong_aozhou_zhuanjia_qiehuan.main_gui(file_textbox.text(),start_textbox_kami.text(),checkboxess,file_textbox_tz_dizhi.text(),file_textbox_jiekou_dizhi.text(),combo_box222_zhuanjia.currentText(),combo_box222_zhuanjia_gen_fan.currentText(),combo_box222_zhuanjia_jianyishou.currentText())
...
app = QApplication([])
window = QWidget()
window.setWindowTitle("模拟测试-澳洲专家")
...
#专家配置选择
bottom_layout2_zhuanjia = QHBoxLayout()
label2222_zhuanjia = QLabel("请选择专家")
bottom_layout2_zhuanjia.addWidget(label2222_zhuanjia)
combo_box222_zhuanjia = QComboBox()
combo_box222_zhuanjia.addItems(["力薄才疏","鲁班","惹不起","老表","肉白骨","嫩草"])
bottom_layout2_zhuanjia.addWidget(combo_box222_zhuanjia)

combo_box222_zhuanjia_gen_fan = QComboBox()
combo_box222_zhuanjia_gen_fan.addItems(["跟专家","反专家"])
bottom_layout2_zhuanjia.addWidget(combo_box222_zhuanjia_gen_fan)

combo_box222_zhuanjia_jianyishou = QComboBox()
combo_box222_zhuanjia_jianyishou.addItems(["保持现状","去最大","去最小"])
bottom_layout2_zhuanjia.addWidget(combo_box222_zhuanjia_jianyishou)


bottom_layout2_saidao = QHBoxLayout()
label2222_saidao = QLabel("请选择赛道：")
bottom_layout2_saidao.addWidget(label2222_saidao)
#
grid_layout = QGridLayout()

# 创建复选框
checkboxes = [QCheckBox(f"第{i + 1}名") for i in range(10)]
...
for i, checkbox in enumerate(checkboxes):
    ...
    #checkbox.stateChanged.connect(on_checkbox_state_changed)  # 连接信号和槽
...
layout.addLayout(bottom_layout2_zhuanjia)
layout.addLayout(bottom_layout2_saidao)
...
def on_button_clicked():
    ...
    for box in checkboxes:
        if(box.isChecked() == True):
            checkboxess.append(box.text())
    print("checkboxess---",checkboxess)
