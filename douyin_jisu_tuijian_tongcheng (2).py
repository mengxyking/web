    ...
    while (b_count < 100000000):
        ...
        try:
            ...
            if (d(text='点击进入直播间').exists(timeout=1)):
                ...
                continue
            time.sleep(0.2)
            if (d(textContains='预约').exists(timeout=1)):
                #beisaier_random(d)
                time.sleep(2)
                continue
            time.sleep(0.2)
            ...
            for tongchengguanjianzi_temp in tongchengguanjianzis:
                time.sleep(0.2)
                if(d(text=tongchengguanjianzi_temp).exists(timeout=1.5)):
                    flagggg = True
                    break
                time.sleep(1)
            if(flagggg == False):
            ...
            if (first_home_filter == "一小时内"):
                ...
                # shijianguanjianzis.append("1小时前")
                # shijianguanjianzis.append("2小时前")
                # shijianguanjianzis.append("3小时前")
                ...
                # shijianguanjianzis.append("3小时前")
                # shijianguanjianzis.append("4小时前")
                # shijianguanjianzis.append("5小时前")
                # shijianguanjianzis.append("6小时前")
                # shijianguanjianzis.append("7小时前")
                # shijianguanjianzis.append("8小时前")
                # shijianguanjianzis.append("9小时前")
                # shijianguanjianzis.append("10小时前")
