    ...
    with lock:
        ...
        if (result_touzhu == "1"):
            ...
            if (fanhuishouye != None):
                ...
                #     time.sleep(1)
                #     # time.sleep(5)
def jianshuo(alldata,driver,touzhu,mingci_flag,touzhu_flag,jiekoudizhi,ex,feiting_dizhi,touzhu_zhengfan,zhengfan):
    ...
    while (True):
        ...
        # try:
            ...
            if(touzhu[dangqiancixu] == 0):
                print("开始-------------------------等一手--------------------------")
                print("当前需要等一手")
                temp_small = getData_qishu_2_feiting(feiting_dizhi)
                print("当前飞艇期数是。。。。。。。。。。------------------》",temp_small)
                while (True):
                    time.sleep(8)
                    count_0 = count_leading_zeros(touzhu)
                    temp  = getData_qishu_2_feiting(feiting_dizhi)
                    ...
                    if(temp_small != temp):
                        ...
                        result_2 = getData_feiting(count_0, int(mingcishuzu[mingcishuzu_index]),feiting_dizhi)
                        ...
                        if (touzhu_flag == "大小"):
                            ...
                            if (int(result_2) < 6):
                                ...
                                if(zhengfan == "跟飞艇"):
                                    if (aozhoujieguo > 5):
                                        print("跟飞艇，澳洲的结果是大，符合要求。。。")
                                        dangqiancixu += 1
                                        break
                                else:
                                    if(aozhoujieguo<6):
                                        print("反飞艇，澳洲的结果是xiao，符合要求。。。")
                                        dangqiancixu += 1
                                        break
                            else:
                                print("飞艇的结果 是 大")
                                if (zhengfan == "跟飞艇"):
                                    if (aozhoujieguo < 6):
                                        print("gen飞艇，澳洲的结果是小，符合要求。。。等手OK")
                                        dangqiancixu += 1
                                        break
                                else:
                                    print("飞艇的结果 是 大")
                                    if (aozhoujieguo > 5):
                                        print("反飞艇，澳洲的结果是da，符合要求。。。等手OK")
                                        dangqiancixu += 1
                                        break
                        if (touzhu_flag == "单双"):
                            aozhoujieguo = getData(count_0, int(mingcishuzu[mingcishuzu_index]),jiekoudizhi)
            ...
            print("计算后，飞艇的开奖时间:", kaijiangshijian)
...
def main_tz(path,touzhujine,shuzu,monidizhi,jiekoudizhi,ex,feiting_dizhi,touzhu_zhengfan):
    ...
    for temp in shuzu:
        ...
        if(len(str(result_alldata))>8):
            thread = threading.Thread(target=jianshuo, args=(result_alldata,driver,touzhujine, temp["mingci"], leixing_flag, jiekoudizhi,ex,feiting_dizhi,touzhu_zhengfan,temp["zhengfan"]))
            thread.start()
