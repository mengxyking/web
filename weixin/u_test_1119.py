...
def register(device,row1,ocr):
    ...
    try:
        ...
        for i in range(5):
            ...
            if (d(text="我已閱讀並同意私隱條款").exists(timeout=2)):
                # d(text="关注").click()
                print("我已閱讀並同意私隱條款")
        ...
        for i in range(5):
            d=check_and_reconnect(d,device)
            if (d(text="下一步").exists(timeout=2)):
                # d(text="关注").click()
                print("下一步")
...
def jiaoyanma(device):
    ...
    for i in range(5):
        d=check_and_reconnect(d, device)
        if (d(textContains = "無障礙方式").exists(timeout=2)):
            # d(text='添加评论...').click()
            print("無障礙方式")
            time.sleep(3)
...
#devices = ["192.168.11.214:5001","192.168.11.214:5002","192.168.11.214:5003","192.168.11.214:5004","192.168.11.214:5005",
           # "192.168.11.214:5006","192.168.11.214:5007","192.168.11.214:5008","192.168.11.214:5009","192.168.11.214:5010",
           # "192.168.11.214:5011","192.168.11.214:5012","192.168.11.214:5013","192.168.11.214:5014","192.168.11.214:5015"]
devices = ["192.168.11.214:5010","192.168.11.214:5012","192.168.11.214:5013","192.168.11.214:5014"]
