...
def main_control(serial):
    ...
    if(str(task).count("douyinyanghao")):
        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "app商城")
        print("")
        main_douyin(serial)
    return "88"
...
def main_douyin(serial):
    ...
    app_package_map = {
        ...
        "河马剧场": "com.dz.hmjc",
        "得间免费小说": "com.chaozh.iReader.dj",
        "酷安": "com.coolapk.market",
        "韩小圈": "com.babycloud.hanju",
        "WiFi万能钥匙": "com.snda.wifilocating",
        "抖音APP": "com.ss.android.ugc.aweme"
    }
    ...
    for pp in range(1):
        print(f"{serial}---->开始第{pp}次")

        for task_app in tasks:
            ...
            if(task_app == "七猫免费小说"):
                try:
                    result_qimao = qimao(serial, d, app_package_map[task_app],w,h)
                    if (result_qimao == 1):
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "qimao成功")
                        sousuo_douyin_2(serial,d)
                    else:
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "qimao失败")
            ...
            if (task_app == "河马剧场"):
                try:
                    result_hema = hema(serial,d, app_package_map[task_app])
                    if(result_hema ==1):
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "hema成功")
                        sousuo_douyin(serial, d)
                    else:
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "盒马失败")
                    time.sleep(random.randint(3, 6))
                    d.press("home")
                    time.sleep(random.randint(3, 6))
                except BaseException as e:
            ...
            if (task_app == "得间免费小说"):
                try:
                    result_qimao = dejian(serial,d, app_package_map[task_app],w,h)
                    if (result_qimao == 1):
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "dejian成功")
                        #sousuo_douyin(serial, d)
                    else:
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "dejian失败")
                    time.sleep(random.randint(3, 6))
                    d.press("home")
                    time.sleep(random.randint(3, 6))
                except BaseException as e:
            ...
            if (task_app == "酷安"):
                try:
                    result_qimao = kuan(serial,d, app_package_map[task_app],w,h)
                    if (result_qimao == 1):
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "酷安成功")
                        sousuo_douyin(serial, d)
                    else:
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "酷安失败")
                    time.sleep(random.randint(3, 6))
                    d.press("home")
                    time.sleep(random.randint(3, 6))
                except BaseException as e:
            ...
            if (task_app == "韩小圈"):
                try:
                    result_qimao = hanxiaoquan(serial,d, app_package_map[task_app],w,h)
                    sousuo_douyin(serial, d)
                    if (result_qimao == 1):
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "韩小圈成功")
                    else:
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "韩小圈失败")
                    time.sleep(random.randint(3, 6))
                    d.press("home")
                    time.sleep(random.randint(3, 6))
                except BaseException as e:
                    print(e)
            if (task_app == "WiFi万能钥匙"):
                try:
                    result_qimao = wannengyaoshi(serial,d, app_package_map[task_app],w,h)
                    if (result_qimao == 1):
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "万能钥匙成功")
                        sousuo_douyin(serial, d)
                    else:
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "万能钥匙失败")
                    time.sleep(random.randint(3, 6))
                    d.press("home")
                    time.sleep(random.randint(3, 6))
                except BaseException as e:
            ...
            if (task_app == "抖音APP"):
                try:
                    result_qimao = douyin_app(serial,d, app_package_map[task_app], w, h)
                    if (result_qimao == 1):
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "抖音成功")
                        sousuo_douyin(serial, d)
                    else:
                        updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "抖音失败")
                    time.sleep(random.randint(3, 6))
                    d.press("home")
                    d.app_stop(package_name=app_package_map[task_app])
                    time.sleep(random.randint(3, 6))
                except BaseException as e:
                    print(e)
...
class PklViewer(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle(f"直播间挂机,欢迎:{get_real_device_id()}")
        ...
        self.radio_button1 = QCheckBox("抖音商城")
    ...
    def init_douyin_tab(self):
        ...
        self.douyin_guanjianzi_wenben_tongcheng = QLabel('直播间挂机时长:')
        ...
        self.douyin_guanjianzi_wenben_huifu = QLabel('直播间关键字:')
        self.douyin_guanjianzi_wenben_huifu.setFixedWidth(105)
