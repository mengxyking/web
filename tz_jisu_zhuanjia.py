...
def run_script():
    ...
    try:
        ...
        jingdong_jisu_zhuanjia.main_gui(file_textbox.text(),start_textbox_kami.text(),checkboxess,file_textbox_tz_dizhi.text(),file_textbox_jiekou_dizhi.text(),combo_box222_zhuanjia.currentText(),combo_box222_zhuanjia_gen_fan.currentText())
...
app = QApplication([])
window = QWidget()
window.setWindowTitle("模拟测试-极速专家")
...
combo_box222_zhuanjia.addItems(["料事如神","能掐会算","鸟枪换炮","连胜","罗斯","老前辈","人上人","人穷志远"])
