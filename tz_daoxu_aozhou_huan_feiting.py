...
import time
import uuid
import jingdong_daoxu_aozhou_huan_feiting
...
def run_script():
    ...
    try:
        ...
        for temp in shuzu:
            print(temp)
        print("开始执行脚本")
        jingdong_daoxu_aozhou_huan_feiting.main_gui(file_textbox.text(),start_textbox_kami.text(),shuzu,file_textbox_tz_dizhi.text(),file_textbox_jiekou_dizhi.text())
...
app = QApplication([])
window = QWidget()
window.setWindowTitle("模拟测试-幸运飞艇")
...
combo_box2222.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box3333.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box4444.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box5555.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box5555_add_1.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box6666.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box7777.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box8888.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box9999.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box10101010.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box11111111.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box12121212.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box13131313.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box14141414.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box15151515.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box16161616.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box17171717.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box18181818.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box19191919.addItems(["大","小",  "单", "双","龙","虎"])
...
combo_box20202020.addItems(["大","小",  "单", "双","龙","虎"])
...
def on_button_clicked():
    ...
    updata_pkl("daxiao1", combo_box2222.currentText())
