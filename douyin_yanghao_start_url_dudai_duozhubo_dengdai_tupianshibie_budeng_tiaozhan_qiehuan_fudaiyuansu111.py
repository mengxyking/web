    ...
    try:
        ...
        if ("fudai" in task):
            ...
            if (jinrufangshi == "通过关注进入"):
                ...
                if (new_flag == "newer"):
                    if(d(descriptionContains="直播，按钮").exists(timeout=3)):
                        print("点直播按钮")
                ...
                try:
                    if (new_flag == "newer"):
                        ...
                        if (d(resourceId=fudai_resourceId).exists(timeout=3)):  # com.ss.android.ugc.aweme:id/yxl
                                        ...
                                        if (flag_guanjianzi == 0):
                                            ...
                                            if (zhubo_len == 1):
                                                ...
                                                if (d(description='说点什么...').exists(timeout=3)):
                                                    print(f"{serial}---->当前在直播间，没有弹窗")
                                                else:
                                                    print(f"{serial}---->按了一次返回")
                                                    d.press("back")
                                                time.sleep(15)
                                                print("fanhui")
                                                continue
                            ...
                            #     #     continue
                            #     if (d(description='说点什么...').exists(timeout=3)):
                            #         print(f"{serial}---->当前有 说点什么")
                            #     else:
                            #         print(f"{serial}---->当前按了一次返回")
                            #         d.press("back")
                            #     time.sleep(60 * 2)
                            #     flag = 1
                            # else:
                            ...
                            if (str(all_data).count("我的等级特权") > 0):
                                ...
                                print(serial + "---------", "有我的等级特权")
                                if (d(description='说点什么...').exists(timeout=3)):
                                    print(serial + "---------我等等级特权，不用返回", "")
                                else:
                                    print(f"{serial}---->我的等级特权 需要返回")
                                    d.press("back")
                                flag = 1
                                continue
                            else:
                            ...
                            if (str(all_data).count("做任务赚宝石") > 0 or str(all_data).count("宝石换钻") > 0):
                                ...
                                if (d(description='说点什么...').exists(timeout=3)):
                                    print(serial + "---------做任务赚宝石，不用返回", "")
                                else:
                                    print(f"{serial}---->做任务赚宝石 需要返回")
                                    d.press("back")
                                time.sleep(2)
                                flag = 1
                            else:
                            ...
                            #     time.sleep(sleep_time_phone)
                            #     print("有我知道啦")
                            #     if (str(all_data).count("知道") > 0):
                            #         # d(text='我知道了').click()
                            #         point = ocr.getPoint_by_data(all_data, "知道")
                            #         if (point != None):
                            #             d.click(point[0] + random.randint(-3, 3), point[1] + random.randint(-3, 3))
                            #
                            #         print("有我知道啦")
                            ...
                            if (str(all_data).count("等待开奖") > 0):
                                ...
                                #         #ocr = OCRProcessor()
                                #         print(f"重新获取ocr之后={ocr}")
                                #     count_00 = ocr.getCount_by_data_from_small_area(all_data, "00", 100, 3000, 800,
                                #                                                     3000)
                                #     if (count_00 == None):
                                #         count_00 = 0
                                #     if (count_00 > 1):
                                #         print(f"{serial}---->00-00了")
                                #         d.press("back")
                                #         break
                                #     if (str(all_data).count("等待开奖") > 0):
                                #         print(f"{serial}当前还有弹窗")
                                #     else:
                                #         print(f"{serial}当前没还弹窗，退出大循环")
                                #         break
                                #
                                #     if (iii > 4):
                                #         print(f"{serial}超过5分钟了")
                                #         d.press("back")
                                #         break
                                #
                                #     if (str(all_data).count("我知道了") > 0):
                                #         # d(text='添加评论...').click()
                                #         updata_pkl("./shuju/" + serial + ".pkl", "进行的任务", "没有中奖")
                                #         point = ocr.getPoint_by_data(all_data, "我知道了")
                                #         if (point != None):
                                #             time.sleep(15)
                                #             #d.click(point[0] + random.randint(-3, 3), point[1] + random.randint(-3, 3))
                        ...
                        if (d(text='立即领取奖品').exists(timeout=1)):
                            ...
                            if (len(lingling) > 1):
                                ...
                                if (d(description='说点什么...').exists(timeout=1)):
                                    ...
                                    print(serial + "---------", "19")
                                    print(f"{serial}---->11111111111返回，福袋页面了")
                                    d.press("back")
