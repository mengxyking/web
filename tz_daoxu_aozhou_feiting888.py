...
import time
import uuid
import jingdong_daoxu_aozhou_feiting888
...
def run_script():
    ...
    try:
        ...
        for temp in shuzu:
            print(temp)
        print("开始执行脚本")
        jingdong_daoxu_aozhou_feiting888.main_gui(file_textbox.text(),start_textbox_kami.text(),shuzu,file_textbox_tz_dizhi.text(),file_textbox_jiekou_dizhi.text(),"",touzhu_zhengfan.currentText())
