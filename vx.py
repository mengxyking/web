...
def xiaoyewu(d,serial,search_path,sixin_comment):
    ...
    # if (d(resourceId='com.tencent.mm:id/h5n').exists(timeout=3)):
    #     # d(text='添加朋友').click()
    #     mm = d(resourceId='com.tencent.mm:id/h5n')
    #     if(len(mm)>2):
    #         random_click_view(d, d(resourceId='com.tencent.mm:id/h5n')[1].info)
    #     time.sleep(random.randint(3, 5))
    # else:
    #     print("首页没有添加好友按钮")
    #     return 0
    # time.sleep(4)
    # if (d(resourceId="com.tencent.mm:id/mmz").exists(timeout=3)):
    #     # d(text='账号/手机号').click()
    #     d(resourceId="com.tencent.mm:id/mmz").click()
    #     time.sleep(random.randint(3, 5))
    # else:
    #     print("首页没有添加好友按钮")
    #     return 0
    ...
    if (search_key == None):
        return 88
    cmd = f"adb -s {serial} shell input text " + str(search_key).strip()
    shell_neibu(cmd)
    time.sleep(random.randint(3, 5))

    if (d(resourceId='com.tencent.mm:id/mdo').exists(timeout=3)):
        # d(textStartsWith='搜索').click()
        d(resourceId='com.tencent.mm:id/mdo').click()
        time.sleep(random.randint(3, 5))
    else:
        print("首页没有搜索按钮")
        return 0
...
class PklViewer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.radio_button1 = QCheckBox("微信加好友")
